...
public class TrackerForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mJPanel1 = new ejotrackeruni.mJPanel();
        ...
        marqueePanel1 = new ejotrackeruni.MarqueePanel();
        ...
        FlagPic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ejotrackeruni/ejo.gif"))); // NOI18N
        ...
        MapPic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ejotrackeruni/ejo.gif"))); // NOI18N
        ...
        CreditsMenu.addMenuListener(new javax.swing.event.MenuListener() {
            public void menuCanceled(javax.swing.event.MenuEvent evt) {
            }
            public void menuDeselected(javax.swing.event.MenuEvent evt) {
            }
            public void menuSelected(javax.swing.event.MenuEvent evt) {
                CreditsMenuMenuSelected(evt);
            }
        });
        MainMenu.add(CreditsMenu);
                                ...
                                if (TI.isAllowNotifications() && SystemTray.isSupported()) {
                                    ...
                                    if (plrs > (TI.isBodyParkedOnServerMode() ? 1 : 0)) {
                                        ...
                                        if (Bother) {
                                            ...
                                            Tray.displayMessage(SC.AppName, msg, TrayIcon.MessageType.NONE);
                                            cont = 0;
                                        }
                                    } else {
                                        Bother = true;
        ...
        Thread RefreshTITD = new Thread(() -> {
            while (true) {
                try {
                    ...
                    EJOTrackerUni.CheckIfThereIsUpdate();
                    synchronized (LockTI) {
                        TI.RefreshTI();
                    }
                } catch (Exception ex) {
    ...
    private void CreditsMenuMenuSelected(javax.swing.event.MenuEvent evt) {//GEN-FIRST:event_CreditsMenuMenuSelected
        // TODO add your handling code here:
        CreditsForm cf = new CreditsForm(this);
    ...
    public final void Init() throws UnknownHostException, SocketException {
        ServerIP = InetAddress.getByName(TI.getServerIP());
        ServerPort = Integer.parseInt(TI.getServerPort());
        Socket = new DatagramSocket();
        Socket.setSoTimeout(1000);
        RequestStatus = new byte[]{(byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, 0x02, 0x67, 0x65, 0x74, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73};
        ReceiveData = new byte[2048];
        SendStatusPacket = new DatagramPacket(RequestStatus, RequestStatus.length, ServerIP, ServerPort);
        ReceiveDataPacket = new DatagramPacket(ReceiveData, ReceiveData.length);
    }
    ...
    public void RefreshFrame() {
        ...
        sbPN.append(SC.PLAYER_INFO_HTML_1);
        sbPS.append(SC.PLAYER_INFO_HTML_1);
        sbPP.append(SC.PLAYER_INFO_HTML_1);
        int j = 0;
        ...
        sbPN.append(SC.PLAYER_INFO_HTML_2);
        sbPS.append(SC.PLAYER_INFO_HTML_2);
        sbPP.append(SC.PLAYER_INFO_HTML_2);
        ...
        try {
            ...
            icon.setImage(Toolkit.getDefaultToolkit().getImage(TrackerForm.class.getResource(SI.getMapnamePic())));
            MapPic.setIcon(icon);
        } catch (Exception ignored) {
            ImageIcon icon = new ImageIcon();
            icon.setImage(Toolkit.getDefaultToolkit().getImage(TrackerForm.class.getResource("ejo.gif")));
            MapPic.setIcon(icon);
        }
...
//    }
    ...
    private ejotrackeruni.mJPanel mJPanel1;
    private ejotrackeruni.MarqueePanel marqueePanel1;
